...
Tween.prototype.reverse = function() {
	this.setup(this.from, this.to, this.duration, this.func);
}

/**
* Tween.goto(to : nnumber, duration : number [, func : function]);
*  - tweens to the next value from it's current value.
**/
Tween.prototype.toward = function(to, duration, func) {
	this.setup(this.value, to, duration, func);
}
